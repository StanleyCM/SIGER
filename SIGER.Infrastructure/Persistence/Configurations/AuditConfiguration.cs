...
public class AuditConfiguration : IEntityTypeConfiguration<Audit>
{
    public void Configure(EntityTypeBuilder<Audit> builder)
    {
        ...
        builder.Property(audit => audit.EntityId).HasColumnName("entidad_id");
        ...
        builder.Property(audit => audit.IpAddress).HasColumnName("direccion_ip").HasConversion(ipAddressConverter).HasColumnType("inet");
