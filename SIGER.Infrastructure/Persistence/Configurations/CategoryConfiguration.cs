...
public class CategoryConfiguration : IEntityTypeConfiguration<Category>
{
    public void Configure(EntityTypeBuilder<Category> builder)
    {
        ...
        builder.Property(category => category.Description).HasColumnName("descripcion").HasMaxLength(255);
        builder.Property(category => category.IsActive).HasColumnName("activo").IsRequired();
