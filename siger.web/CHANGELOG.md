...
- Cree un proyecto de React con create-vite: `npm init --yes vite@latest "siger.web" -- --template=react  --no-rolldown --no-immediate --eslint`.
- Actualizando `vite.config.js` con puerto.
- Crear archivo de proyecto (`siger.web.esproj`).
